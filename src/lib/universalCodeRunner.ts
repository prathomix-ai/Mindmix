// ─────────────────────────────────────────────────────────────────────────────
// MindMix — Universal Multi-Language Code Execution Engine
...
SELECT * FROM students WHERE score >= 90;`,
  ...
  <h2 style="margin: 0 0 10px 0;">✦ MindMix Live Code Component</h2>
...
SELECT * FROM students WHERE score >= 90;`,
  ...
  <h2 style="margin: 0 0 8px 0; font-size: 20px;">✦ MindMix Live Preview</h2>
...
for ($i = 1; $i <= 6; $i++) {
    echo "Iteration $i: Hello MindMix!\\n";
}
?>`,
    },
  ],
