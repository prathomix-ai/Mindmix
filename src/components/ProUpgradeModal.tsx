      ...
      >
        ...
        >
          ...
          <p className="text-xs sm:text-sm text-zinc-300 leading-relaxed mb-4">
            Upgrade to <strong className="text-cyan-400">MindMix PRO</strong> to get unlimited access to advanced AI intelligence, real-time cloud sync, and clean watermark-free exports.
          </p>
