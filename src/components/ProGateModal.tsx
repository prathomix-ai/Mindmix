      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md">
        ...
        >
          ...
          <p className="text-sm text-zinc-300 leading-relaxed">
            <strong className="text-white">{featureName}</strong> is an exclusive superpower reserved for <strong className="text-neon-cyan">MindMix PRO</strong> subscribers. Upgrade now to empower your workflow with next-gen AI and team sync.
          </p>
