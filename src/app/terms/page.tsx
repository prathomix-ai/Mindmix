...
export const metadata = {
  title: "Terms and Conditions | MindMix AI Whiteboard",
  description: "Terms and Conditions governing the use of MindMix AI SaaS platform by PRATHOMIX.",
};
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 md:py-16 space-y-12">
        <div className="border-b border-zinc-800 pb-8 space-y-4">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            These Terms and Conditions (&ldquo;Terms&rdquo;) constitute a legally binding agreement between you (&ldquo;User&rdquo;, &ldquo;Client&rdquo;, or &ldquo;Subscriber&rdquo;) and PRATHOMIX SOLUTION (&ldquo;Company&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;), governing access to and usage of the MindMix AI Smart Whiteboard platform (&ldquo;Platform&rdquo;, &ldquo;Service&rdquo;).
          </p>
        </div>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-zinc-300 leading-relaxed">
            By creating an account, accessing, drawing upon, or authenticating into the MindMix platform, you unconditionally accept and agree to be bound by all provisions within this Master Agreement. If you do not agree to these terms in their entirety, you must terminate use immediately.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-zinc-300 leading-relaxed">
            MindMix incorporates cutting-edge Large Language Models (LLMs), neural semantic search, and WebAssembly Python compilers. You expressly recognize and acknowledge:
          </p>
        ...
        <section className="space-y-3 border-t border-zinc-800 pt-8">
          ...
          <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 text-xs font-mono text-zinc-400 space-y-1">
            <div>Operating Body: PRATHOMIX SOLUTION (MindMix Platform)</div>
