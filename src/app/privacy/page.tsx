...
export const metadata = {
  title: "Privacy Policy | MindMix AI Whiteboard",
  description: "Privacy Policy governing data processing, local execution, and third-party storage on MindMix.",
};
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 md:py-16 space-y-12">
        <div className="border-b border-zinc-800 pb-8 space-y-4">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            This Privacy Policy describes how PRATHOMIX (&ldquo;Company&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;) handles information across the MindMix AI SaaS platform, specifically highlighting local browser sandboxing and third-party infrastructure boundaries.
          </p>
        </div>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-zinc-300 leading-relaxed">
            To provide enterprise-grade scale, database persistence, and AI inference, MindMix interfaces with select third-party infrastructure providers:
          </p>
        ...
        <section className="space-y-3 border-t border-zinc-800 pt-8">
          ...
          <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 text-xs font-mono text-zinc-400 space-y-1">
            <div>Privacy Desk: PRATHOMIX SOLUTION (MindMix Division)</div>
