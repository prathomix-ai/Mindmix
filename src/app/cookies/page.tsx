...
export const metadata = {
  title: "Cookie Policy | MindMix AI Whiteboard",
  description: "Pro-company Cookie Policy for MindMix AI Smart Whiteboard SaaS platform by PRATHOMIX.",
};
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 md:py-16 space-y-12">
        ...
        <div className="border-b border-zinc-800 pb-8 space-y-4">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-white font-mono">
            MINDMIX COOKIE &amp; LOCAL STORAGE POLICY
          </h1>
          <p className="text-sm text-zinc-400 leading-relaxed">
            This Cookie Policy constitutes a binding legal agreement governing the operation of cookies, Web Storage (localStorage, sessionStorage), IndexedDB, and related telemetry on the MindMix SaaS platform (&ldquo;Platform&rdquo;, &ldquo;Service&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;), operated by PRATHOMIX (&ldquo;Company&rdquo;).
          </p>
        </div>
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm text-zinc-300 leading-relaxed">
            By accessing or using the MindMix platform, you expressly authorize and consent to the placement, reading, and transmission of Essential and Technical Storage Objects on your device as defined herein.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm text-zinc-300 leading-relaxed">
            Unlike static promotional websites, MindMix operates an event-driven collaborative whiteboard engine. The following cookies and client-side storage objects are <strong>MANDATORY</strong> and cannot be opted out of without terminating the functionality of the Service:
          </p>
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm text-zinc-300 leading-relaxed">
            MindMix interfaces with premier third-party cloud service providers, vector databases, and AI inference networks (including, but not limited to, Supabase Inc., Hugging Face Inc., Cloudflare Inc., Amazon Web Services, and CDN delivery networks) to deliver scalable computational power.
          </p>
        ...
        <section className="space-y-4 border-t border-zinc-800 pt-8">
          ...
          <div className="p-5 rounded-lg border border-zinc-800 bg-zinc-900/40 text-sm space-y-2">
            ...
            <p className="text-zinc-400 text-xs">
              Entity: PRATHOMIX SOLUTION (MindMix Division)<br />
              Digital Portal:{" "}
              <a
